"""Notebook-facing workflow helpers for encoding analyses.

These helpers keep encoding scripts focused on analysis decisions while handling
subject-level reuse, saving, and summary tables in one place.
"""
