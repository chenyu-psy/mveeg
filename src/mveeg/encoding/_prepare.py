...
RESERVED_TRIAL_COLUMNS = {"training_group", "expression_group"}
...
def validate_groups(
    ...
    if missing:
        raise ValueError(f"expression must include every conditions value; missing {missing}.")
...
def select_trials(
    ...
    *,
    ...
    training_labels = map_values(values, conditions)
    expression_labels = map_values(values, expression)
